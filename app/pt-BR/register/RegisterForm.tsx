  ...
  return (
    ...
    >
      <input
        ...
        onFocus={e => (e.currentTarget.style.border = '2px solid #7c3aed')}
      ...
      >
        {loading ? (
          <span style={{ display: 'inline-flex', alignItems: 'center', gap: 8 }}>
            <span className="loader" style={{ width: 18, height: 18, border: '3px solid #fff', borderTop: '3px solid #7c3aed', borderRadius: '50%', display: 'inline-block', animation: 'spin 1s linear infinite' }} />
            Criando...
          </span>
        ) : (
          'Criar Conta'
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 2, fontSize: 15 }}>
        <a href="/pt-BR/login" style={{ color: '#38bdf8', fontWeight: 700, textDecoration: 'underline', opacity: 0.92 }}>Já tenho conta</a>
      </div>
      <style>{`
        @keyframes spin {
